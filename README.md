...
This enables the platform to move from passive monitoring to AI-driven incident analysis. When an alert is triggered, the AI engine receives the payload and starts the automated investigation workflow.
